            ...
            <div class="col-lg-8 table-responsive mb-5">
                <table class="table table-bordered text-center mb-0">
                    ...
                    @foreach( $commande->lignecommandes as $lc )
                            <tr>
                                <td class="align-middle"><img src="{{ asset('uploads') }}/{{ $lc->product->photo }}" alt=""
                                        style="width: 50px;">{{ $lc->product->name }}</td>
                                ...
                                <td class="align-middle"><a href="/client/lc/{{ $lc->id }}/destroy" class="btn btn-sm btn-primary"><i
