            ...
            <div class="d-flex align-items-center">
                <div class="d-flex align-items-center">
                    <a href="/admin/dashboard">
                        <p class="logo-text ms-2 d-none d-sm-block">ModelFashion</p>
                    </a>
                </div>
            </div>
        </a></div>
        ...
        <ul class="navbar-nav navbar-nav-icons ms-auto flex-row">
            <li class="nav-item dropdown"><a class="nav-link" id="navbarDropdownNotification" href="#"
                    role="button" data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false"><span
                        class="text-700" data-feather="bell"
                            ...
                            <div class="row text-center align-items-center gx-0 gy-0">
                                <div class="col-4"><a
                                        ...
                                        href="#!" target="_blank"><img
                                            src="{{ asset ('dashassets/img/nav-icons/behance.png') }}" alt="" width="30">
                                ...
                                <div class="col-4"><a
                                        class="d-block hover-bg-200 p-2 rounded-3 text-center text-decoration-none mb-3"
                                        href="#!" target="_blank"><img
                                            src="{{ asset ('dashassets/img/nav-icons/google-cloud.png') }}" alt="" width="30">
                                        <p class="mb-0 text-black text-truncate fs--2 mt-1 pt-1">Cloud</p>
                                    </a></div>
                                <div class="col-4"><a
                                        class="d-block hover-bg-200 p-2 rounded-3 text-center text-decoration-none mb-3"
                                        href="#!" target="_blank"><img src="{{ asset ('dashassets/img/nav-icons/slack.png') }}"
                                            alt="" width="30">
                                        <p class="mb-0 text-black text-truncate fs--2 mt-1 pt-1">Slack</p>
                                    </a></div>
                                <div class="col-4"><a
                                        class="d-block hover-bg-200 p-2 rounded-3 text-center text-decoration-none mb-3"
                                        href="#!" target="_blank"><img src="{{ asset ('dashassets/img/nav-icons/Github.png') }}"
                                            alt="" width="30">
                                ...
                                <div class="col-4"><a
                                        class="d-block hover-bg-200 p-2 rounded-3 text-center text-decoration-none mb-3"
                                        href="#!" target="_blank"><img
                                            src="{{ asset ('dashassets/img/nav-icons/bitbucket.png') }}" alt="" width="30">
                                ...
                                <div class="col-4"><a
                                        class="d-block hover-bg-200 p-2 rounded-3 text-center text-decoration-none mb-3"
                                        href="#!" target="_blank"><img
                                            src="{{ asset ('dashassets/img/nav-icons/google-drive.png') }}" alt="" width="30">
                                        <p class="mb-0 text-black text-truncate fs--2 mt-1 pt-1">Drive</p>
                                    </a></div>
                                <div class="col-4"><a
                                        class="d-block hover-bg-200 p-2 rounded-3 text-center text-decoration-none mb-3"
                                        href="#!" target="_blank"><img src="{{ asset ('dashassets/img/nav-icons/trello.png') }}"
                                            alt="" width="30">
                                        <p class="mb-0 text-black text-truncate fs--2 mt-1 pt-1">Trello</p>
                                    </a></div>
                                <div class="col-4"><a
                                        class="d-block hover-bg-200 p-2 rounded-3 text-center text-decoration-none mb-3"
                                        href="#!" target="_blank"><img src="{{ asset ('dashassets/img/nav-icons/figma.png') }}"
                                            alt="" width="20">
                                ...
                                <div class="col-4"><a
                                        class="d-block hover-bg-200 p-2 rounded-3 text-center text-decoration-none mb-3"
                                        href="#!" target="_blank"><img
                                            src="{{ asset ('dashassets/img/nav-icons/twitter.png')}}" alt="" width="30">
                                ...
                                <div class="col-4"><a
                                        class="d-block hover-bg-200 p-2 rounded-3 text-center text-decoration-none mb-3"
                                        href="#!" target="_blank"><img
                                            src="{{ asset ('dashassets/img/nav-icons/pinterest.png') }}" alt="" width="30">
                                ...
                                <div class="col-4"><a
                                        class="d-block hover-bg-200 p-2 rounded-3 text-center text-decoration-none mb-3"
                                        href="#!" target="_blank"><img
                                            src="{{ asset ('dashassets/img/nav-icons/linkedin.png') }}" alt="" width="30">
                                ...
                                <div class="col-4"><a
                                        class="d-block hover-bg-200 p-2 rounded-3 text-center text-decoration-none mb-3"
                                        href="#!" target="_blank"><img
                                            src="{{ asset ('dashassets/img/nav-icons/google-maps.png') }}" alt="" width="30">
                                        <p class="mb-0 text-black text-truncate fs--2 mt-1 pt-1">Maps</p>
                                    </a></div>
                                <div class="col-4"><a
                                        class="d-block hover-bg-200 p-2 rounded-3 text-center text-decoration-none mb-3"
                                        href="#!" target="_blank"><img
                                            src="{{ asset ('dashassets/img/nav-icons/google-photos.png') }}" alt="" width="30">
                                        <p class="mb-0 text-black text-truncate fs--2 mt-1 pt-1">Photos</p>
                                    </a></div>
                                <div class="col-4"><a
                                        class="d-block hover-bg-200 p-2 rounded-3 text-center text-decoration-none mb-3"
                                        href="#!" target="_blank"><img
                                            src="{{ asset ('dashassets/img/nav-icons/spotify.png') }}" alt="" width="30">
            ...
            <li class="nav-item dropdown"><a class="nav-link lh-1 px-0 ms-5" id="navbarDropdownUser"
                    ...
                    aria-expanded="false">
                    <div class="avatar avatar-l"><img class="rounded-circle" src="{{ asset('mainassets/img/user.jpg') }}"
                            alt=""></div>
                </a>
                        ...
                        <div class="card-body p-0 overflow-auto scrollbar" style="height: 18rem;">
                            <div class="text-center pt-4 pb-3">
                                <div class="avatar avatar-xl"><img class="rounded-circle"
                                        src="{{ asset('mainassets/img/20.jpg') }}" alt=""></div>
                            ...
                            <ul class="nav d-flex flex-column mb-2 pb-1">
                                <li class="nav-item"><a class="nav-link px-3"
                                        href="/admin/profile"><span class="me-2 text-900"
