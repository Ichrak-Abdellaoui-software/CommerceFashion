                            ...
                            <div class="row text-center align-items-center gx-0 gy-0">
                                <div class="col-4"><a
                                        ...
                                        href="#!" target="_blank"><img
                                            src="{{ asset('dashaassets/img/nav-icons/behance.png') }}" alt="" width="30">
                                ...
                                <div class="col-4"><a
                                        class="d-block hover-bg-200 p-2 rounded-3 text-center text-decoration-none mb-3"
                                        href="#!" target="_blank"><img
                                            src="dashassets/img/nav-icons/google-cloud.png" alt="" width="30">
                                ...
                                <div class="col-4"><a
                                        class="d-block hover-bg-200 p-2 rounded-3 text-center text-decoration-none mb-3"
                                        href="#!" target="_blank"><img src="{{ asset('assets/img/nav-icons/github.png') }}"
                                            alt="" width="30">
                        ...
                        <div class="card-body p-0 overflow-auto scrollbar" style="height: 18rem;">
                            <div class="text-center pt-4 pb-3">
                                <div class="avatar avatar-xl"><img class="rounded-circle"
                                        src="{{ asset('mainassets/img/user.jpg') }}" alt=""></div>
                            ...
                            <ul class="nav d-flex flex-column mb-2 pb-1">
                                <li class="nav-item"><a class="nav-link px-3"
                                        href="/client/profile"><span class="me-2 text-900"
