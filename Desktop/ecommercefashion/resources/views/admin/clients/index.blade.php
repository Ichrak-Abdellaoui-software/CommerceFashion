                                    ...
                                    <table class="table table-bordered">
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                              ...
                                              <td>
                                                @if ($client->is_active)
                                                <span class="badge bg-info"> Utilisateur Active </span>
                                                    
                                                @else
                                                <span class="badge bg-success"> Utilisateur Bloquee</span>
                                              ...
                                              <td> <a href="/admin/user/{{ $client->id }}/bloquer" class="btn btn-danger">bloquee</a></td>
                                            </tr>
